...
namespace SDBS3000
{
    ...
    public partial class NewMessageBox
    {
        ...
        {
            NMessageBox window = null;
            System.Windows.Application.Current.Dispatcher.Invoke(new Action(() =>
            {
                window = NMessageBox.Getbox();
            }));
            ...
            Application.Current.Dispatcher.Invoke(new Action(() =>
            {
                if (!window.IsVisible)
                    window.ShowDialog();
                //Write(LogType.ERROR, "消息提示：" + cmessageBoxText);
            }));
        ...
        public static CMessageBoxResult Show(string cmessageBoxText, CMessageBoxButton CMessageBoxButton = CMessageBoxButton.OK)
        {
            NMessageBox window = null;
            Application.Current.Dispatcher.Invoke(new Action(() =>
            {
