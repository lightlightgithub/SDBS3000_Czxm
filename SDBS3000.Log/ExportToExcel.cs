                ...
                for (int i = 0; i < propertys.Count(); i++)
                {
                    ...
                    if (Attribute.IsDefined(propertys[i], (typeof(DescriptionAttribute))))
                    {
                        try
                        {
                            ...
                            sb2.Append("[");
                            sb2.Append(Convert.ToString(((DescriptionAttribute)propertys[i].GetCustomAttribute(typeof(DescriptionAttribute))).Description));
                            sb2.Append("]");
                            //rowH.CreateCell(i).SetCellValue(LanguageManager.Instance.);
